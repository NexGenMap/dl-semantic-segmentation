...
image2 = pathImgs + "SB-24-Z-D-2018-07-01-2018-08-01.vrt" #sys.argv[2]
...
if(hasReferenceImage):
	referenceImage = pathRef + "SB-24-Z-D_classCampos.tif" #sys.argv[3]
	outputImage = refSaida #sys.argv[4]
else:
	outputImage = pathRef #sys.argv[3]
